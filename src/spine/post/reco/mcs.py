...
class MCSEnergyProcessor(PostBase):
    ...
    def __init__(
        ...
        apply_csda_prior_to_contained=False,
        ...
        **kwargs,
        ...
        csda_mode : str, default 'lower_bound'
            CSDA prior mode to use in `mcs_fit` ('gaussian' or 'lower_bound')
        apply_csda_prior_to_contained : bool, default False
            If `False`, only apply the CSDA prior to exiting tracks
        ...
        **kwargs : dict, optiona
        ...
        self.csda_mode = csda_mode
        self.apply_csda_prior_to_contained = apply_csda_prior_to_contained
    ...
    def process(self, data):
        ...
        for k in self.fragment_keys + self.particle_keys:
            for obj in data[k]:
                ...
                csda_ke = None
                if self.use_csda_prior:
                    if self.apply_csda_prior_to_contained or not obj.is_contained:
